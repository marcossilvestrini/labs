...
1. You [open a discussion](https://github.com/marcossilvestrini/labs/discussions) to discuss any significant work with the maintainer(s).
...
```shell
git remote add upstream https://github.com/marcossilvestrini/labs.git
...
discuss, [open a discussion](https://github.com/marcossilvestrini/labs/discussions).
