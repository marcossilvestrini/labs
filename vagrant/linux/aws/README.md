...
This project up a stack of AWS for labs.

## Whats is?

In this project, I up a stack of AWS.

### Vagrant

 I use vagrant for provision all aws servers in this project.

### Shell provisioner

I use vagrant shell provisioner for configure aws service and others tools of this stack

### Git Actions (pipelines)

I use git actions for create a pipeline for my test in aws stack
