...
This project up a stack of File share servers with pureftp.

## Whats is?

In this project, I up a stack of File share servers with pureftp.
...
I use git actions for create a pipeline for my test in pureftp stack
...
* [Pure-FTP](https://www.pureftpd.org/project/pure-ftpd/)
